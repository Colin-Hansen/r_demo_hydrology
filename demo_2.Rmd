...
## Boxplots - Daily Rainfall

```{r boxplots-rainfall-multi-site, eval= TRUE, echo = FALSE,include = TRUE, message=FALSE, warning=FALSE, results = 'asis'}
    ...
    # create boxplots
      ...
      # ggplot(data=rainfall_multi_NZ, aes(x=stn_id_factor,y=total_rain,fill=stn_id_factor)) +
...
## Quantile- Quantile Plot (Edm. Int'l A # 1865)
